...
import { User, MenuService, LogoService, FooterService } from 'kaishi';
...
export class AppComponent {
  ...
  constructor(private footerServ: FooterService, private menuServ: MenuService, private logoServ: LogoService) {}
